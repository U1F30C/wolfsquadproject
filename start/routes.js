...
Route.on('/recover_password').render('recover-password').as('passwordRecovery').middleware(['guest'])
Route.on('/new_password').render('new-password').as('passwordChange').middleware(['auth'])
Route.on('/new_email').render('new-email').as('emailChange').middleware(['auth'])

Route.on('/schools').render('create-schools-form').as('schoolsManagement').middleware(['auth'])
Route.on('/automatic-school-form').render('school-automatic-form').as('automaticForm').middleware(['auth'])
Route.on('/manual-school-form').render('school-manual-form').as('manualForm').middleware(['auth'])
